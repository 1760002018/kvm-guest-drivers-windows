 ...
 * Definitions shared by pioinput and hidpassthrough.
 *
 * Copyright (c) 2017 Blu Tah, Inc.
 * Author: Ladi Prosek <lprosek@blutah.com>
 */
...
{
    /* This extension is an interface between pioinput and hidpassthrough.
