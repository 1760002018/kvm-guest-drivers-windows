=================================================
Phyzio-Serial driver user-mode interface library.
=================================================
...
1.1 PIOSStartup
The PIOSStartup method activates the Phyzio-Serial driver user-mode interface library.
...
Return Value
If the PIOSStartup method encounters no errors, it returns TRUE. Otherwise it returns FALSE.

Comments
None

1.2 PIOSCleanup
The PIOSCleanup method deactivates the Phyzio-Serial driver user-mode interface library.
DLL_API
VOID
PIOSCleanup(void)
...
1.8 NumPorts
The NumPorts method returns number of Phyzio-Serial Ports in the system.
DLL_API
UINT
NumPorts(void);
...
Return Value
The number of Phyzio-Serial Ports in the system.
