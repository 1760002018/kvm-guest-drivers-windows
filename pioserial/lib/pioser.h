...
typedef BOOL (WINAPI PIOSERIALNOTIFYCALLBACK)(PVOID pRef);

DLL_API BOOL PIOSStartup(void);
DLL_API VOID PIOSCleanup(void);
...
DLL_API VOID RegisterNotification(PVOID port, PIOSERIALNOTIFYCALLBACK pfn, PVOID ptr);
