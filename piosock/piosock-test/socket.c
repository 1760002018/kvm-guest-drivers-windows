...
)
{
    ...
    UNICODE_STRING usDeviceName = RTL_CONSTANT_STRING(PIOSOCK_NAME);
...
{
    DWORD dwBytes;
    return DeviceIoControl((HANDLE)hPiosock, IOCTL_GET_CONFIG, NULL, 0, pConfig, sizeof(*pConfig), &dwBytes, NULL);
}
