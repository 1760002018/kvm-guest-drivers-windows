// RegAccess.h: interface for the neTPTVRegAccess class.
//
//////////////////////////////////////////////////////////////////////
...
class neTPTVRegAccessConstructorFailedException : public neTPTVException
{
public:
    neTPTVRegAccessConstructorFailedException() :
      neTPTVException(TEXT("Can't construct neTPTVRegAccess object"))
    { }
};

class neTPTVRegAccess
{
public:
    neTPTVRegAccess();
    neTPTVRegAccess(HKEY hNewPrKey, LPCTSTR lpzNewRegPath);
    virtual ~neTPTVRegAccess();
