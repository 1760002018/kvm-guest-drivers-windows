...
private:
    ...
    void PrepareOffloads(phyzio_net_hdr *PhyzioHeader, PVOID IpHeader, ULONG EthPayloadLength, ULONG L4HeaderOffset) const;
    void SetupLSO(phyzio_net_hdr *PhyzioHeader, PVOID IpHeader, ULONG EthPayloadLength) const;
    ...
    void SetupCSO(phyzio_net_hdr *PhyzioHeader, ULONG L4HeaderOffset) const;
    bool FillDescriptorSGList(CTXDescriptor &Descriptor, ULONG DataOffset) const;
    bool MapDataToPhyzioSGL(CTXDescriptor &Descriptor, ULONG Offset) const;
