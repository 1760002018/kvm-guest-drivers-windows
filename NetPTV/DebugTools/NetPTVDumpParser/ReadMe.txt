========================================================================
    CONSOLE APPLICATION : NetPTVDumpParser Project Overview
========================================================================

Usage currently is trivial:
NetPTVDumpParser dump-file

To be useful, must process dumps from latest version of NETPTV,
...
(NetPTVDumpParser now does not use it, just checks whether symbols are loaded).
