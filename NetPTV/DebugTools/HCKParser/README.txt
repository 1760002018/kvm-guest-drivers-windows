...
out of order packet delivery  by the NetPTV network driver.
...
and 23.
    ...
    The pcap files may be collected both inside the Windows moozes
with wireshark and on host, by listening on the 'tap' networking
device with wireshark or tcpdump.

    Please, notice that when running wireshark inside Windows mooze
