...
NetPTV supports both "WPP" tracing and "kdprint" tracing. By default the WPP
...
"#define NETPTV_WPP_ENABLED" from the Trace.h file.

* Note that in NetPTV WPP is supported only from Win7 and higher
